...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: The PersonQueue class was using Insert(0, person) instead of Add(person), causing LIFO behavior instead of FIFO.
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: The queue removed items with infinite turns (<= 0) instead of re-enqueueing them without decreasing their turn count.
